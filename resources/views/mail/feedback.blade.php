<div class="mail-content">
    ...
    <h2>Уважаемый {{ $book->user->getNameAndSurname() }}!</h2>
    <p>Благодарим вас, что выбрали нашу клинику</p>
    <p>Пожалуйста оцените специалиста <span class="specialist">{{ $book->specialist->user->getNameAndSurname()}}</span>, по шкале от 1 до 5</p>
