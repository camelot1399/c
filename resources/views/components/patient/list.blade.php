                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a id={{$book->user_id}} href="#"  data-trigger onClick="getId(event)">{{$book->user->name . ' ' . $book->user->surname }}</a>
                                                        </h2>
                                                    </td>
...
{{--                                                    <td>New Patient</td>--}}
                                                    ...
                                                    <td class="text-right">
                                                        <div class="table-action">
                                                            <a id={{$book->user_id}} href="javascript:void(0);" data-trigger
                                            ...
                                            @foreach($books as $book)
                                                @if(date('d M Y', strtotime(today()->toDateTimeString())) == date('d M Y', strtotime($book->datetime )))
                                                    <tr>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a id={{$book->user_id}} href="#"  data-trigger>{{ $book->user->name . ' ' . $book->user->surname }}</a>
                                                            </h2>
                                                        </td>
                                                        <td>{{  date('d M Y', strtotime($book->datetime )) }}<span
                                                                class="d-block text-info">{{ date('h:i', strtotime($book->datetime )) }}</span>
